...
# Execute the program as ./rld_FCC.sh <lattice parameter from bulk relaxation>

lp=$1 # Here the $1 is the user-inputted lattice parameter found out from bulk relaxation (convenetional unit cell)
